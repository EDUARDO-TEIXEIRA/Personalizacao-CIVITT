...
public class Login {
	public String getOperador(String tabela, BigDecimal pkRegistro, String usuario, String senha, boolean retornaBase64) throws Exception {
		...
		Collection<DynamicVO> filtroOperador = (Collection<DynamicVO>) 
				...
				new FinderWrapper(tabela, "this.CODEMP = ?", pkRegistro));
