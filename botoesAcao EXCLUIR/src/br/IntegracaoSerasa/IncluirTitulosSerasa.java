...
public class IncluirTitulosSerasa implements AcaoRotinaJava{
	...
	private void inclusaoSerasa() throws Exception {
        ...
        String bodyResponse = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:web=\"http://webservice.spc.insumo.spcjava.spcbrasil.org/\"> "
        							+ "<soapenv:Header/> <soapenv:Body> <web:incluirSpc> "
        								+ "<insumoSpc> <tipo-pessoa>J</tipo-pessoa> "
        										   + " <dados-pessoa-juridica> "
        										   	...
        										   	+ "</dados-pessoa-juridica> "
        										   	+ "<data-compra>2014-02-01T21:02:14</data-compra> "
        										   	...
        										   	+ "<valor-debito>100.00</valor-debito> "
        										   	+ "<natureza-inclusao> <id>1</id> </natureza-inclusao> "
        										   	+ "<endereco-pessoa> "
        										   		+ "<cep>-11740000</cep> "
        										   		+ "<logradouro>Avenida Condessa</logradouro> "
        										   		+ "<bairro>Centro</bairro> "
        										   		+ "<numero>999</numero> "
        										   	+ "</endereco-pessoa> "
        								+ "</insumoSpc> </web:incluirSpc> </soapenv:Body> </soapenv:Envelope>";
