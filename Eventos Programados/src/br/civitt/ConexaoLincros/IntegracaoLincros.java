...
public abstract class IntegracaoLincros {
	...
	public static void conexaoHTTP(byte[] xml) throws IOException ,Exception {
		...
		//File arquivoXML = ArquivosUtil.gerarArquivo(xml);
		//byte[] arquivosBinarios = Files.readAllBytes (arquivoXML.toPath ());
		...
		connection.setRequestProperty("Authorization", "Bearer " + br.civitt.Utilitarios.PreferenciaSistemaUtil.getOperador());
    ...
    public static void addArquivoRequisicao(String fieldName, File uploadFile)
            throws IOException {
